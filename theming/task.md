Теперь мы улучшим темизацию страницы, добавив акцентный цвет и единообразную типографику.Ваша задача:1. определите следующие новые CSS-переменные:В :root--accent-color: #1e90ff; --heading-font: 'Arial', sans-serif; --body-font: 'Verdana', sans-serif;2.Примените эти переменные по всей странице: для текста Используйте --body-fontbody. для заголовков (Используйте --heading-fonth1, h2).Установите цвет h2 равным --accent-color.Стилизуйте кнопку, используя  в качестве её фона.--accent-colorЦель: Теперь у страницы должна быть четкая тема с единообразными шрифтами и акцентным цветом, примененным к заголовкам и кнопкам.<!DOCTYPE html>
<html>
<head>
